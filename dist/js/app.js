 ...
 */
    ...
    (() => {
        ...
        const openCatalog = document.querySelector(".menu-open-catalog");
        const catalogBody = document.querySelector(".menu-catalog__body");
        function menuInit() {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".time-buy__slider")) new core(".time-buy__slider", {
            ...
            if (document.querySelector(".about-product__slider")) new core(".about-product__slider", {
            ...
            if (document.querySelector(".about-product__slider-mini")) {
                new core(".about-product__slider-mini", {
                    slidesPerView: 3,
                    spaceBetween: 30,
                    speed: 300
                });
            }
            if (document.querySelector(".recently-viewed__slider")) new core(".recently-viewed__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        var u = (p, b, g) => (E(p, "symbol" != typeof b ? b + "" : b, g), g);
        (function(p, b) {
            "object" == typeof exports && "undefined" != typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : (p = "undefined" != typeof globalThis ? globalThis : p || self, 
            p.JustValidate = b());
        })(void 0, (function() {
            "use strict";
            const p = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, b = /^[0-9]+$/, g = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/, x = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, I = n => {
                let e = n;
                return "string" == typeof n && (e = n.trim()), !e;
            }, T = n => p.test(n), $ = (n, e) => n.length > e, M = (n, e) => n.length < e, V = n => b.test(n), P = n => g.test(n), j = n => x.test(n), G = (n, e) => n > e, A = (n, e) => n < e;
            var d;
            (function(n) {
                n.Required = "required", n.Email = "email", n.MinLength = "minLength", n.MaxLength = "maxLength", 
                n.Password = "password", n.Number = "number", n.MaxNumber = "maxNumber", n.MinNumber = "minNumber", 
                n.StrongPassword = "strongPassword", n.CustomRegexp = "customRegexp", n.MinFilesCount = "minFilesCount", 
                n.MaxFilesCount = "maxFilesCount", n.Files = "files";
            })(d || (d = {}));
            var y;
            (function(n) {
                n.Required = "required";
            ...
            class O {
                constructor(e, t, s) {
                    ...
                    u(this, "formSubmitHandler", (e => {
                        e.preventDefault(), this.isSubmitted = !0, this.globalConfig.lockForm && this.lockForm(), 
                        this.validate().finally((() => {
                            var t, s;
                            this.globalConfig.lockForm && this.unlockForm(), this.isValid ? null == (t = this.onSuccessCallback) || t.call(this, e) : null == (s = this.onFailCallback) || s.call(this, this.fields);
                        }));
                    }));
                    ...
                    u(this, "handlerChange", (e => {
                        !e.target || (this.handleFieldChange(e.target), this.handleGroupChange(e.target), 
                        this.renderErrors());
                    }));
                    this.initialize(e, t, s);
                }
                initialize(e, t, s) {
                    if (this.form = null, this.errors = {}, this.isValid = !1, this.isSubmitted = !1, 
                    this.globalConfig = S, this.errorLabels = [], this.eventListeners = [], this.customStyleTags = {}, 
                    this.tooltips = [], "string" == typeof e) {
                    ...
                    if (this.globalConfig = L(L({}, S), t), s && (this.dictLocale = s), this.isTooltip()) {
                        ...
                        i.textContent = z, this.customStyleTags[k.Label] = document.head.appendChild(i), 
                        this.addListener("scroll", document, this.handleDocumentScroll);
                    }
                }
                getLocalisedString(e) {
                    var s;
                    return !this.currentLocale || !this.dictLocale.length ? e : (null == (s = this.dictLocale.find((i => i.key === e))) ? void 0 : s.dict[this.currentLocale]) || e;
                }
                getFieldErrorMessage(e, t) {
                    const s = "function" == typeof e.errorMessage ? e.errorMessage(this.getElemValue(t), this.fields) : e.errorMessage;
                    return this.getLocalisedString(s) || N(e.rule, e.value);
                }
                getFieldSuccessMessage(e, t) {
                    const s = "function" == typeof e ? e(this.getElemValue(t), this.fields) : e;
                ...
                validateGroupRule(e, t, s, i) {
                    switch (i.rule) {
                      case y.Required:
                        ("radio" === t || "checkbox" === t) && (s.every((r => !r.checked)) ? this.setGroupInvalid(e, i) : this.setGroupValid(e, i));
                    }
                }
                      ...
                      case d.Files:
                        {
                            ...
                            const l = r.files;
                            if ("object" != typeof l) {
                                console.error(`Value for ${s.rule} rule for [${e}] field should be an object with files array. This field will be always invalid.`), 
                                this.setFieldInvalid(e, s);
                                return;
                            }
                            const o = (c, h) => {
                                const f = Number.isFinite(h.minSize) && c.size < h.minSize, m = Number.isFinite(h.maxSize) && c.size > h.maxSize, v = Array.isArray(h.names) && !h.names.includes(c.name), D = Array.isArray(h.extensions) && !h.extensions.includes(c.name.split(".")[c.name.split(".").length - 1]), H = Array.isArray(h.types) && !h.types.includes(c.type);
                                return f || m || v || D || H;
                            };
                            if ("object" == typeof a && null !== a) for (let c = 0, h = a.length; c < h; ++c) {
                                const f = a.item(c);
                                if (!f) {
                                    this.setFieldInvalid(e, s);
                                    break;
                      ...
                      default:
                        {
                            ...
                            if ("boolean" != typeof l && "function" != typeof l && console.error(`Validator return value for [${e}] field should be boolean or function. It will be cast to boolean.`), 
                            "function" == typeof l) if (i) this.fields[e].asyncCheckPending = !0; else {
                ...
                validateField(e, t, s = !1) {
                    ...
                    return [ ...t.rules ].reverse().forEach((a => {
                        ...
                        F(l) && i.push(l);
                    })), t.isValid && this.setFieldValid(e, null == (r = t.config) ? void 0 : r.successMessage), 
                ...
                setForm(e) {
                    this.form = e, this.form.setAttribute("novalidate", "novalidate"), this.removeListener("submit", this.form, this.formSubmitHandler), 
                ...
                removeField(e) {
                    if ("string" != typeof e) throw Error("Field selector is not valid. Please specify a string selector.");
                    if (!this.fields[e]) return console.error("Field not found. Check the field selector."), 
                    this;
                    const t = this.getListenerType(this.fields[e].elem.type);
                    return this.removeListener(t, this.fields[e].elem, this.handlerChange), this.clearErrors(), 
                    delete this.fields[e], this;
                }
                removeGroup(e) {
                    ...
                    })), this.clearErrors(), delete this.groupFields[e], this) : (console.error("Group not found. Check the group selector."), 
                    this);
                }
                addRequiredGroup(e, t, s, i) {
                    ...
                    const a = r.querySelectorAll("input"), l = Array.from(a).every((c => "radio" === c.type)), o = Array.from(a).every((c => "checkbox" === c.type));
                ...
                clearErrors() {
                    ...
                    for (const l in this.fields) {
                        const o = this.fields[l], c = (null == (e = o.config) ? void 0 : e.errorFieldStyle) || this.globalConfig.errorFieldStyle;
                        Object.keys(c).forEach((f => {
                            o.elem.style[f] = "";
                        }));
                        const h = (null == (t = o.config) ? void 0 : t.successFieldStyle) || this.globalConfig.successFieldStyle || {};
                        Object.keys(h).forEach((f => {
                            o.elem.style[f] = "";
                        })), o.elem.classList.remove((null == (s = o.config) ? void 0 : s.errorFieldCssClass) || this.globalConfig.errorFieldCssClass, (null == (i = o.config) ? void 0 : i.successFieldCssClass) || this.globalConfig.successFieldCssClass);
                    }
                    for (const l in this.groupFields) {
                        const o = this.groupFields[l], c = (null == (r = o.config) ? void 0 : r.errorFieldStyle) || this.globalConfig.errorFieldStyle;
                        Object.keys(c).forEach((f => {
                            o.elems.forEach((m => {
                                var v;
                                m.style[f] = "", m.classList.remove((null == (v = o.config) ? void 0 : v.errorFieldCssClass) || this.globalConfig.errorFieldCssClass);
                            }));
                        }));
                        const h = (null == (a = o.config) ? void 0 : a.successFieldStyle) || this.globalConfig.successFieldStyle || {};
                        Object.keys(h).forEach((f => {
                            o.elems.forEach((m => {
                                var v;
                                m.style[f] = "", m.classList.remove((null == (v = o.config) ? void 0 : v.successFieldCssClass) || this.globalConfig.successFieldCssClass);
                            }));
                        }));
                    }
                    this.tooltips = [];
                ...
                lockForm() {
                    ...
                    for (let t = 0, s = e.length; t < s; ++t) e[t].setAttribute("disabled", "disabled"), 
                    e[t].style.pointerEvents = "none", e[t].style.webkitFilter = "grayscale(100%)", 
                    e[t].style.filter = "grayscale(100%)";
                }
                unlockForm() {
                    const e = this.form.querySelectorAll("input, textarea, button, select");
                    for (let t = 0, s = e.length; t < s; ++t) e[t].removeAttribute("disabled"), e[t].style.pointerEvents = "", 
                    e[t].style.webkitFilter = "", e[t].style.filter = "";
                }
                renderTooltip(e, t, s) {
                    var f;
                    const {top: i, left: r, width: a, height: l} = e.getBoundingClientRect(), o = t.getBoundingClientRect(), c = s || (null == (f = this.globalConfig.tooltip) ? void 0 : f.position);
                    switch (c) {
                      case "left":
                ...
                createErrorLabelElem(e, t, s) {
                    ...
                    i.innerHTML = t;
                    const r = this.isTooltip() ? null == s ? void 0 : s.errorLabelStyle : (null == s ? void 0 : s.errorLabelStyle) || this.globalConfig.errorLabelStyle;
                    return Object.assign(i.style, r), i.classList.add((null == s ? void 0 : s.errorLabelCssClass) || this.globalConfig.errorLabelCssClass, "just-validate-error-label"), 
                    this.isTooltip() && (i.dataset.tooltip = "true"), this.globalConfig.testingMode && (i.dataset.testId = `error-label-${e}`), 
                    this.errorLabels.push(i), i;
                }
                createSuccessLabelElem(e, t, s) {
                    if (void 0 === t) return null;
                    const i = document.createElement("div");
                    i.innerHTML = t;
                    const r = (null == s ? void 0 : s.successLabelStyle) || this.globalConfig.successLabelStyle;
                    return Object.assign(i.style, r), i.classList.add((null == s ? void 0 : s.successLabelCssClass) || this.globalConfig.successLabelCssClass, "just-validate-success-label"), 
                    this.globalConfig.testingMode && (i.dataset.testId = `success-label-${e}`), this.successLabels.push(i), 
                    i;
                }
                renderFieldLabel(e, t) {
                    ...
                    if ("checkbox" === e.type || "radio" === e.type) {
                        ...
                        "label" === (null == (i = null == (s = e.parentElement) ? void 0 : s.tagName) ? void 0 : i.toLowerCase()) ? null == (a = null == (r = e.parentElement) ? void 0 : r.parentElement) || a.appendChild(t) : h ? null == (l = h.parentElement) || l.appendChild(t) : null == (o = e.parentElement) || o.appendChild(t);
                    ...
                    if (!!this.isSubmitted) {
                        ...
                        for (const l in this.groupFields) {
                            ...
                            if (o.isValid) {
                                o.elems.forEach((f => {
                                    var m, v;
                                    Object.assign(f.style, (null == (m = o.config) ? void 0 : m.successFieldStyle) || this.globalConfig.successFieldStyle), 
                                    f.classList.add((null == (v = o.config) ? void 0 : v.successFieldCssClass) || this.globalConfig.successFieldCssClass);
                                }));
                            ...
                            this.isValid = !1, o.elems.forEach((h => {
                                var f, m;
                                Object.assign(h.style, (null == (f = o.config) ? void 0 : f.errorFieldStyle) || this.globalConfig.errorFieldStyle), 
                                h.classList.add((null == (m = o.config) ? void 0 : m.errorFieldCssClass) || this.globalConfig.errorFieldCssClass);
                            }));
                            const c = this.createErrorLabelElem(l, o.errorMessage, o.config);
                            o.groupElem.appendChild(c), this.isTooltip() && this.tooltips.push(this.renderTooltip(o.groupElem, c, null == (t = null == (e = o.config) ? void 0 : e.tooltip) ? void 0 : t.position));
                        }
                        for (const l in this.fields) {
                            ...
                            if (o.isValid) {
                                if (!o.asyncCheckPending) {
                                    const h = this.createSuccessLabelElem(l, o.successMessage, o.config);
                                    h && this.renderFieldLabel(o.elem, h), o.elem.classList.add((null == (s = o.config) ? void 0 : s.successFieldCssClass) || this.globalConfig.successFieldCssClass);
                                }
                                continue;
                            }
                            this.isValid = !1, o.elem.classList.add((null == (i = o.config) ? void 0 : i.errorFieldCssClass) || this.globalConfig.errorFieldCssClass);
                            const c = this.createErrorLabelElem(l, o.errorMessage, o.config);
                            this.renderFieldLabel(o.elem, c), this.isTooltip() && this.tooltips.push(this.renderTooltip(o.elem, c, null == (a = null == (r = o.config) ? void 0 : r.tooltip) ? void 0 : a.position));
                        }
                    }
                }
                destroy() {
        ...
        //! Preloader
                if (document.querySelector(".loader")) document.documentElement.classList.add("lock");
        function fadeOut() {
            window.addEventListener("load", (function() {
                setTimeout((function() {
                    document.documentElement.classList.remove("lock");
